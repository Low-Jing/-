...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__FITNESSPRO__",
    appName: "fitness_uniapp_pro",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"fitness_uniapp_pro","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*******************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/pages.json ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

throw new Error("Module build failed (from ./node_modules/@dcloudio/webpack-uni-pages-loader/lib/index.js):\nTypeError: Cannot read properties of undefined (reading 'renderer')\n    at weixinSkyline (C:\\Users\\羽\\Documents\\HBuilderX.4.87.2025121004\\HBuilderX\\plugins\\uniapp-cli\\node_modules\\@dcloudio\\webpack-uni-pages-loader\\lib\\platforms\\mp.js:218:17)\n    at C:\\Users\\羽\\Documents\\HBuilderX.4.87.2025121004\\HBuilderX\\plugins\\uniapp-cli\\node_modules\\@dcloudio\\webpack-uni-pages-loader\\lib\\platforms\\mp.js:372:33\n    at C:\\Users\\羽\\Documents\\HBuilderX.4.87.2025121004\\HBuilderX\\plugins\\uniapp-cli\\node_modules\\@dcloudio\\webpack-uni-pages-loader\\lib\\platforms\\mp-weixin\\index.js:5:23\n    at Object.<anonymous> (C:\\Users\\羽\\Documents\\HBuilderX.4.87.2025121004\\HBuilderX\\plugins\\uniapp-cli\\node_modules\\@dcloudio\\webpack-uni-pages-loader\\lib\\index-new.js:188:71)\n    at Object.<anonymous> (C:\\Users\\羽\\Documents\\HBuilderX.4.87.2025121004\\HBuilderX\\plugins\\uniapp-cli\\node_modules\\@dcloudio\\webpack-uni-pages-loader\\lib\\index.js:55:35)");
...
/* 42 */
/*!*************************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/utils/request.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _config = __webpack_require__(/*! @/common/config.js */ 43);
var _session = __webpack_require__(/*! @/utils/session.js */ 44);
function isPublicUrl(url) {
  return url.indexOf('/users/login/') !== -1 || url.indexOf('/users/register/') !== -1;
}
function request(options) {
  return new Promise(function (resolve, reject) {
    ...
    var userId = (0, _session.getUserId)();
    ...
    uni.request({
      ...
      success: function success(res) {
        if (res.statusCode >= 200 && res.statusCode < 300) {
          // 新旧两种响应格式都兼容
          if (res.data && (0, _typeof2.default)(res.data) === 'object' && res.data.hasOwnProperty('code') && res.data.hasOwnProperty('data')) {
...
/* 43 */
/*!*************************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/common/config.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 44 */
/*!*************************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/utils/session.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 53 */
/*!********************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/api/home.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getGrowthSummary = getGrowthSummary;
...
/* 60 */
/*!*********************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/api/plans.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getPlanEngine = getPlanEngine;
exports.getPlanList = getPlanList;
var _request = __webpack_require__(/*! @/utils/request.js */ 42);
function getPlanEngine(userId) {
  return (0, _request.request)({
    url: '/plans/engine/?user_id=' + userId,
    method: 'GET'
  });
}
...
function getPlanDashboard(userId) {
  return (0, _request.request)({
    url: '/plans/dashboard/?user_id=' + userId,
    method: 'GET'
  });
}
function getCheckinList(userId) {
  return (0, _request.request)({
...
/* 69 */
/*!********************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/api/user.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 70 */
/*!***********************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/api/records.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function getRecordList(userId) {
  return (0, _request.request)({
    url: '/health/records/list/?user_id=' + userId,
    method: 'GET'
  });
}
...
/* 79 */
/*!************************************************************************************!*\
  !*** D:/graduation_project/fitness_system/frontend/fitness_uniapp/api/discover.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getDiscoverGrowthSummary = getDiscoverGrowthSummary;
exports.getDiscoverHome = getDiscoverHome;
exports.toggleArticleFavorite = toggleArticleFavorite;
exports.toggleChallengeJoin = toggleChallengeJoin;
exports.toggleCourseFavorite = toggleCourseFavorite;
exports.togglePostLike = togglePostLike;
var _request = __webpack_require__(/*! @/utils/request.js */ 42);
function getDiscoverHome(userId) {
  return (0, _request.request)({
    url: '/discover/home/?user_id=' + userId,
    method: 'GET'
  });
}
function getDiscoverGrowthSummary(userId) {
  return (0, _request.request)({
    url: '/discover/user-summary/?user_id=' + userId,
    method: 'GET'
  });
}
function toggleChallengeJoin(userId, challengeId) {
  return (0, _request.request)({
...
function toggleCourseFavorite(userId, courseId) {
  return (0, _request.request)({
